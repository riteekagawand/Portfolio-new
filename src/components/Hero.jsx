  ...
  return (
    <>
      <main className="pt-20 lg:pt-[0rem] bg-[#0f1629] text-white min-h-screen">
        <section id="home" className="hero min-h-screen flex items-center relative px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-6 sm:mb-8">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight">
                  <SparklesText text="Namaste( );" className="font-roboto" />
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                AI Enthusiast 🤖 | Full Stack Developer 💻 | Building the future with code and creativity 🌟✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                >
                  <a
                    href="https://drive.google.com/uc?export=download&id=17f49hQwDln8KRap57gtEqlI5sKEmUJGY"
                    download
                  >
